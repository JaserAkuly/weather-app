...
//weatherApp.controller('weatherCtrl', function ($scope, $http, $interval) {
//    $scope.user = {};
//
//    var c = 0;
//
...
//            $http({
//                method: 'GET',
//                url: 'http://api.openweathermap.org/data/2.5/weather?&APPID=7c99bd12f8e57f1557fe0472e9ea0a64&q='
//            }).then(function successCallback(response) {
//                console.log("Got success!", response);
//                //$scope.temperature = response.data.main.temp;
//
//                if ($scope.format === 'Fahrenheit') {
//
...
//        }
//        getTemp();
//        $scope.message= "Div Has Been Changed";
//        c++;
//    },1000);
//
    ...
    .controller('weatherCtrl', function ($scope, $interval, $http) {
        $interval(function () {
            ...
            $http({
                ...
                console.log("Got success!", response);
                $scope.temperature_max = response.data.main.temp_max;
                $scope.temperature_min = response.data.main.temp_min;
